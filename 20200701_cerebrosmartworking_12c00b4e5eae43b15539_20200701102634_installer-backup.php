...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200701_cerebrosmartworking_12c00b4e5eae43b15539_20200701102634_archive.zip';
	const ARCHIVE_SIZE		 = '52338991';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '12c00b4-01102634';
    const SECONDARY_PACKAGE_HASH = 'b6ebbda-01102634';
